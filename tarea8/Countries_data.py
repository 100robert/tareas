...
# 4. total de numeros de paises
num_paises = set()
for country in countries:
    paises = country['name']
    num_paises.add(paises)
print("numero total de paises")
print(len(num_paises))
num_leng = num_lenguaje(countries)
#tay loco
